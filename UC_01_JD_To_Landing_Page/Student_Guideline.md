# Hướng dẫn học tập (Student Guideline): Chuyển đổi JD thành Landing Page

Chào mừng bạn đến với học phần thực hành chuyển đổi Bản mô tả công việc (JD) thành một trang Landing Page tuyển dụng chuyên nghiệp. Hướng dẫn này giúp bạn tự học cách vận hành AI Agent để tạo ra sản phẩm hoàn chỉnh.
...
👉 **[03_Prompt_LandingPage_V2.md](./03_Prompt_LandingPage_V2.md)**
...
3. Tìm file **`landing_page.html`** mới được sinh ra.
...
- **Vị trí lưu trữ:** File Landing Page sinh ra luôn nằm cùng thư mục với file JD đỏ của bạn.


## 4. Xuất bản và chia sẻ

Để xuất bản Landing Page thành file PDF hoặc Ảnh để gửi báo cáo, bạn có 3 cách thực hiện (Khuyến khích dùng Cách 1):
...
- **Cách 1: Sử dụng AI Agent xuất PDF tự động (Pageless PDF)**
  ...
  > *"Hãy chạy script `04_export_pageless_pdf.py` để xuất file `landing_page.html` thành PDF nhé."*
...
Để trang Landing Page trông chuyên nghiệp và đúng với hình ảnh công ty bạn, hãy thực hiện các tùy chỉnh sau tại nhà:

### 🎨 Tùy chỉnh màu sắc

Trong file **[03_Prompt_LandingPage_V2.md](./03_Prompt_LandingPage_V2.md)**, hãy tìm đến phần **Brand Guidelines** và thay đổi mã màu (Hex Code) theo ý muốn:
